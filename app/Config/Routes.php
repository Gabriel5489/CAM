...
$routes->get('/list_user', 'admin::list_user');
$routes->get('/citas', 'admin::citas');
$routes->get('/reportes', 'admin::reportes');
$routes->get('/docente', 'LoginController::docente');
$routes->get('/alumno', 'LoginController::alumno');
$routes->get('/salir', 'LoginController::salir');
$routes->post('/entrar', 'LoginController::entrar');
