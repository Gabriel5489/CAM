        ...
        <div class="e-panel card">
          <div class="card-body">
            <div class="card-title">
              <h6 class="mr-2"><span>Citas</span><small class="px-1"></small></h6>
            </div>
            <div class="e-table">
                    ...
                    <tr>
                      ...
                      <td class="text-center align-middle">
                        <div class="btn-group align-top">
                            <button class="btn btn-sm btn-outline-secondary badge" type="button" data-toggle="modal" data-target="#user-form-modal">Ver cita</button>
                        </div>
                      </td>
                    </tr>
                  </tbody>
